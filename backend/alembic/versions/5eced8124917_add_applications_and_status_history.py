...
Hand-edited: autogenerate declared application_status inline in both
create_table calls, so CREATE TYPE ran twice and the second failed. Types are
now created once with checkfirst and dropped on downgrade.
"""
